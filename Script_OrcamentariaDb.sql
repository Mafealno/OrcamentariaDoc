...
CREATE TABLE IF NOT EXISTS `OrcamentariaDB`.`T_ORCA_CARTA_COBERTURA` (
  ...
  INDEX `FK_T_ORCA_PESSOA_CARTA_COBERTURA_INDEX` (`PESSOA_ID` ASC) INVISIBLE,
  UNIQUE INDEX `UNIQUE` (`REFERENCIA` ASC, `MATERIAL_ID` ASC, `PESSOA_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `OrcamentariaDB`.`T_ORCA_ITENS_CARTA_COBERTURA` (
  ...
  INDEX `FK_T_ORCA_CARTA_COBERTURA_INDEX` (`CARTA_COBERTURA_ID` ASC) INVISIBLE,
